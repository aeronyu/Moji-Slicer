...
- [x] Replace the current mixed `ContentView` with a focused import + grid + preview flow.
- [x] Show the selected image.
- [x] Draw calculated slice boxes.
- [x] Add rows / columns / gap / padding controls.
